function [cvLambda,cvTestErr,optW,resSD,optiLambda,SolutionPath,TestErrInterp,TestRSD,cvSigma] = main_SURF_my(Xten,Xt,Y)
...
for r = 1:R
    ...
    [W, wt, res] = MyTrain(Xten, Xt,Y,epsilon,xi,alpha,absW);
