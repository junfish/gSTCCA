function [cvLambda,cvTestErr,optW,Wt,resSD,optiLambda,SolutionPath,TestErrInterp,TestRSD,cvSigma] = gSTCCA_complete(Xten,Xt,Y,R,epsilon)
...
for r = 1:R
    ...
    [W, wt_r, res] = Train_STAR(Xten, Xt,Y,epsilon,xi,alpha,absW);
...
for i = 1:cvp.NumTestSets
    ...
    Ytest  = Y(teIdx);
    Xttrain = Xt(trIdx,:);
    [Lambda{i,1},TestErr{i,1},TestW{i,1},TestSigma{i,1}] = TrainAndPredict_my(Xtrain,Ytrain, ...
